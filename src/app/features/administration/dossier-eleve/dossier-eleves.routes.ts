...
import { ModificationEleveComponent } from './pages/eleve/modification-eleve-component/modification-eleve-component';
...
export const DOSSIERS_ELEVES_ROUTES: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'eleve/edit/:uuid',
        component: ModificationEleveComponent
      },
      {
